...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface FakeBTCInterface extends Interface {
    getFunction(nameOrSignature: "balanceOf" | "name" | "symbol" | "totalSupply" | "transfer"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transfer', data: BytesLike): Result;
  ...
  export interface FakeBTC extends BaseContract {
    
    connect(runner?: ContractRunner | null): FakeBTC;
    waitForDeployment(): Promise<this>;

    interface: FakeBTCInterface;
